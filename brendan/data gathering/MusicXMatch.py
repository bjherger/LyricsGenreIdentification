...
API_KEY = 'e9afe345f1c625c6a07880b81078e783'
...
def load_API_KEY():
    ...
    if API_KEY is None:
        try:
            API_KEY = bhUtilities.read_file("/Users/bjherger/Desktop/musicxmatch.af"
                                            "txt")
        except:
            print "Error loading API Key. Please place API key in /private/tmp/lyrics/musicxmatch.txt, or hard scraping_code in."
    else:
